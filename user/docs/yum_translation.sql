...
('These users have been assigned to this Role', 'Este usuario ha sido asignado a este Rol', 'es', 'yum'),
...
('These users have visited my profile', 'Estos usuarios han visitado mi perfil', 'es', 'yum'),
